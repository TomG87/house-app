...
class FurnituresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create furniture" do
    assert_difference("Furniture.count") do
      post furnitures_url, params: { furniture: { brand: @furniture.brand, color: @furniture.color, name: @furniture.name, room_id: @furniture.room_id, weight: @furniture.weight } }
    end
  ...
  test "should update furniture" do
    patch furniture_url(@furniture), params: { furniture: { brand: @furniture.brand, color: @furniture.color, name: @furniture.name, room_id: @furniture.room_id, weight: @furniture.weight } }
